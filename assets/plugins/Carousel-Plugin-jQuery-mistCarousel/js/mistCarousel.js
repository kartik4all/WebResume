...
(function() {
	...
	Mistify.prototype.appendMasks = function() {
		...
		var maskDom = '' +
			'<div class="mistify__mask-container">' +
				'<div class="mistify__mask mistify__mask--active"><img src="./assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-1.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="./assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-2.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="./assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-3.png" alt="Mask"/></div>' +
				'<div class="mistify__mask"><img src="./assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-4.png" alt="Mask"/></div>' +
			'</div>';
	...
	Mistify.prototype.preloadMasks = function() {
		...
		var masks = ['./assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-1.png', './assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-2.png', './assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-3.png', './assets/plugins/Carousel-Plugin-jQuery-mistCarousel/img/mistCarousel-4.png']
